...
2. Upload the Hemolab.png logo to Reporting > File Management
3. Go to Workspace Configuration > Data Import and import the ExportData.json
...
If you require assistance or you would like to report a problem, 
please contact support using the website.